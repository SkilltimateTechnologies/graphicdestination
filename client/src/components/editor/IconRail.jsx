...
export default function IconRail({ shapesOpen, setShapesOpen, imagesOpen, setImagesOpen, audioOpen, setAudioOpen, mapsOpen, setMapsOpen, templatesOpen, setTemplatesOpen, chartsOpen, setChartsOpen, confettiOpen, setConfettiOpen, numbersOpen, setNumbersOpen, threeDOpen, setThreeDOpen, audioTrack, addObject }) {
  return (
