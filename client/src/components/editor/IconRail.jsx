/* ============================================================
   ...
   ============================================================ */
import { C } from "./model";
import { RailBtn } from "./ui";
import { ptsToStr, SHAPE_DEFS } from "../../engine/shapes.js";
import { ringsToPath, MAPS } from "../../engine/maps.js";

export default function IconRail({ shapesOpen, setShapesOpen, textOpen, setTextOpen, mapsOpen, setMapsOpen, templatesOpen, setTemplatesOpen, chartsOpen, setChartsOpen, confettiOpen, setConfettiOpen, numbersOpen, setNumbersOpen, uiOpen, setUiOpen, uploadsOpen, setUploadsOpen, svgIconsOpen, setSvgIconsOpen, addObject }) {
  return (
        <div style={{ width: 76, background: C.bg1, borderRight: `1px solid ${C.line}`, display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 12, gap: 9, flexShrink: 0, zIndex: 20, overflowY: "auto" }}>
          ...
          <RailBtn label="Uploads" active={uploadsOpen} onClick={() => setUploadsOpen(!uploadsOpen)} glyph={<svg width="17" height="17" viewBox="0 0 18 18" fill="none" stroke={C.dim} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M9 12.5v-9M5.6 7.4 9 4l3.4 3.4M3 14.5h12" /></svg>} />
